...
export default function TicketPage({ history }) {
    ...
    return (
        <div id='ticketCard' className='font-inter bg-gradient-to-br from-[#20463C] to-[#199675] m-10 p-6 rounded-3xl text-white'>
            ...
            <div className='flex flex-row justify-between'>
                ...
                <button class="self-baseline border-none rounded-xl px-5 py-3 bg-royalblue text-white hover:shadow-md font-semibold" onClick={printTicket}>
                    Print Ticket
                </button>
            </div>
